        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex gap-1.5 ">
            <input
              ...
              className="w-[280px] h-10 py-2 px-4 rounded-md border border-[#E4E4E4] text-[#71717A]"
              type="text"
              placeholder="Add a new task..."
            />
            <Button
              className="w-[59px] h-[40px] border-0 rounded-md bg-[#3C82F6] text-white hover:bg-[#2563EB] transition"
          ...
          <div className="pb-[9px] flex gap-[6px] font-normal">
            <Button className={" bg-[#3C82F6] w-[38px] h-[32px]"}>All</Button>
            <Button className={"bg-[#F3F4F6] w-[60px] h-[32px] text-[#363636]"}>
              Active
            </Button>
            <Button className={"bg-[#F3F4F6] w-[87px] h-[32px] text-[#363636]"}>
              Completed
            </Button>
          </div>
          ...
          <div className="flex justify-center gap-[4px]">
            ...
            <a href="#" className="text-[#3B73ED] font-normal font-xs">
              Pinecone academy
            </a>
          </div>
        </div>
